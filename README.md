...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-14 12:51`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/603b7a0d-6038-42ea-a3ec-467a4a98f839.git
$ cd 603b7a0d-6038-42ea-a3ec-467a4a98f839
```
